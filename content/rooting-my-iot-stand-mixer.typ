...
#let args = (
  title: "Rooting my IoT stand mixer",
  date: "2026-03-14",
  slug: "rooting-my-iot-stand-mixer",
  tags: ("programming", "rust", "iot", "hacking"),
  summary: "Rooting the Kenwood Cooking Chef (KCL96)",
)
...
#note[][
  This post is quite broken and not yet finished, sorry :/
]
...
#html.elem("img", attrs: ("src": "https://github.com/user-attachments/assets/a74881a7-536b-4966-bd2b-ab779822eba5", "alt": "The debug pins of the device, viewing with the PCB at the bottom, UARTTX is top left, UART RX is topright.")){width="80%"}
...
It also uses #link("https://pengutronix.de/en/software/rauc.html")[RAUC] to
handle OTAs.
...
==== A53.service <a53-service>

Handles drawing the GUI using #link("https://embedded-wizard.de/")[Embedded Wizard],
...
==== KitchenOS Agent.service <kitchenos-agent-service>

(TODO: what does this actually do?)

==== aws-iot-proxy <aws-iot-proxy>
...
Then I repeated the same procedure as #link(<u-boot-usb>)[before], but instead
